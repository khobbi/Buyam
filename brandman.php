...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="clearfix">
                <div class="h1 text-start float-start">Brand Management</div>
                <button id="btn-badge" class="btn float-end">New Brand</button>
            </div>
        ...
        <div class="table-responsive-sm">
            <table class="table">
                ...
                <?php 
                    ...
                    $sql = $conn->real_escape_string("SELECT brand_name FROM tb_brands");
